...
Creating a "booking" group
    ...
    [Tags]   AppTab   API10   Regression   Booking
...
Creating a "booking" group
    ...
    [Documentation]    This test adds "booking" to a BR V2 API2.0 bot
    [Tags]   AppTab   API20   Regression   Booking
    [Setup]    Setup Chrome Webdriver and Access URL
               Login   ${credentials}[email]   ${credentials}[password]
...
Adding 4 text items to a "booking" group
    ...
    [Documentation]    This test adds 4 text items (booking_trigger, booking_confirm, booking_reminder, booking_follow_up) to a BR V2 API2.0 bot
    [Tags]   AppTab   API20   Regression   Booking
    [Setup]    Setup Chrome Webdriver and Access URL
               Login   ${credentials}[email]   ${credentials}[password]
               Open Specified Bot   ${bot_names_list}   ${my_api20_bot_name}
